...
- **wikantik-admin-mcp**: Admin MCP server at `/wikantik-admin-mcp` — 22 tools (incl. inspect_proposals, review_proposals, curate_edges, curate_nodes) — reconciled 2026-05-13. See `com.wikantik.mcp.McpServerInitializer`.
