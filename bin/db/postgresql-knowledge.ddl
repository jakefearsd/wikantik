...
-- pgvector extension is required by content_chunk_embeddings (created in
-- migration V009) and hub_centroids (V005). The legacy kg_embeddings /
-- kg_content_embeddings tables that lived here previously were dropped in
-- migration V019 — node similarity is now derived as the centroid of
-- mention-chunk vectors from content_chunk_embeddings.
