# JSPWiki Observability System Design
    ...
    static_configs:
      - targets:
        ...
        labels:
          ...
          app: jspwiki
          log_type: access
          __path__: /var/log/tomcat/access*.log
    pipeline_stages:
    ...
    static_configs:
      - targets:
        ...
        labels:
          ...
          app: jspwiki
          log_type: catalina
          __path__: /var/log/tomcat/catalina*.log
```
