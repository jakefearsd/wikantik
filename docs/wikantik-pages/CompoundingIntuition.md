...
| Annual Return | Double (Rule of 72) | Triple (Rule of 114) | Quadruple (Rule of 144) | 10x (Rule of 240) |
|--------------|--------------------|--------------------|----------------------|-------------------|
| 5% | 14.4 years | 22.8 years | 28.8 years | 48 years |
...
| Rule | Formula | What It Tells You | Example (at 7%) |
|------|---------|-------------------|----------------|
| Rule of 72 | 72 / return = years to 2x | How fast money doubles | ~10 years |
...
- [Basics of Compound Interest](BasicsOfCompoundInterest) — Formal definition and mathematical formulas
- [Rule of 72 and Investment Growth Calculations](RuleOf72AndInvestmentGrowthCalculations) — Extended examples and edge cases
- [Compound Interest and Tax-Advantaged Accounts](CompoundInterestAndTaxAdvantagedAccounts) — How tax-sheltered accounts amplify compounding
- [CoastFIRE](CoastFire) — The retirement strategy that relies entirely on compounding
- [Expense Ratio Deep Dive](ExpenseRatioDeepDive) — How fees compound against you
- [Index Fund Investing for Early Retirement](IndexFundInvestingForEarlyRetirement) — Putting compounding to work in practice
- [A Complete Early Retirement Investment Plan](EarlyRetirementInvestmentPlan) — The full plan that compounding powers
