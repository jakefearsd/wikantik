...
- semi-structured
- gin-index
summary: JSONB in Postgres for flexible schema — query operators, GIN and functional
  indexing, update gotchas, and when JSONB beats EAV or a separate document database.
related:
