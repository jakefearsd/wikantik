...
### 2.2 Mathematical Property
The Lamport clock satisfies the **Clock Consistency Condition**:
$$a \to b \implies L(a) < L(b)$$

**Note:** The converse is NOT true. If $L(a) < L(b)$, we cannot conclude $a \to b$. They could be concurrent.
...
### 3.2 Comparison and Concurrency Detection
