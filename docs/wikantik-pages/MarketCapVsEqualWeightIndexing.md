...
status: active
date: '2026-04-26'
summary: Why market-cap weighting is the default, what equal weighting actually changes,
  and the cases for and against each — with honest assessment of whether the equal-weight
  premium has a real factor explanation.
tags:
- index-funds
