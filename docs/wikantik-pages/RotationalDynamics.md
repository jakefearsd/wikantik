...
For a continuous rigid body rotating in 3D space, $I$ is a second-rank tensor:
...
$$I = I_{cm} + Md^2$$
Where $I_{cm}$ is the moment of inertia about the center of mass and $d$ is the distance to the parallel axis.
...
### 4.1 Euler's Equations for a Rigid Body
