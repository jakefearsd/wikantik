...
Wikantik uses BM25 + dense embeddings for hybrid retrieval. KG reranking is **not used** — it was shelved after a measured zero-lift ceiling spike (2026-06-16) and removed in 2026-07. See `KnowledgeGraphRerank`.
