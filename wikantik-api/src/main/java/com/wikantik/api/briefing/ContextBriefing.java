...
/** The unit a session-start briefing returns: retrieval-driven sections (with coverage), plus
 *  the explicitly pinned/cluster items, warnings, and the token budget actually used. */
