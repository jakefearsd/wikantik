...
/**
 * <p>Represents a logical "unit of work" that includes a request context, URL pattern and (optionally) a target and
 ...
 * ("edit", "view", etc.) except that they include additional, essential properties such as the associated URL pattern.</li>
 ...
 * target object be of type {@link com.wikantik.api.core.Page}.</li>
 * </ul>
...
public interface Command {
     ...
     * <code>null</code>. For example, the static command {@code com.wikantik.ui.PageCommand#VIEW} doesn't require a permission because
     * it isn't referring to a particular WikiPage. However, if this command targets a WikiPage called <code>Main</code>(via
     * {@code com.wikantik.ui.PageCommand#targetedCommand(Object)}, the resulting Command would require the permission
