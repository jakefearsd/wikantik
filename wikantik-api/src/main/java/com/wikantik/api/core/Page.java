...
public interface Page extends Cloneable, Comparable< Page > {
    ...
    /** A special variable name for storing the markup syntax type (e.g., "markdown"). */
     ...
     * {@link com.wikantik.auth.acl.AclManager#setPermissions(com.wikantik.api.core.Page, com.wikantik.api.core.Acl)}.
     *
