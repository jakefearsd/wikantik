 ...
 * <p>Session extends the {@link com.wikantik.event.WikiEventListener} interface and listens for group add/change/delete
 * events fired by event sources the Session is registered with: {@link com.wikantik.auth.AuthenticationManager},
 * {@link com.wikantik.auth.UserManager} and {@link com.wikantik.auth.authorize.GroupManager}, so it can catch group events. Thus,
 * when a user is added to a {@link com.wikantik.auth.authorize.Group}, a corresponding {@link com.wikantik.auth.GroupPrincipal} is
...
public interface Session extends WikiEventListener {
     ...
     * <ul>
     *   <li>The session's Principal set contains {@link com.wikantik.auth.authorize.Role#ANONYMOUS}</li>
     *   <li>The session's Principal set contains {@link com.wikantik.auth.WikiPrincipal#GUEST}</li>
     ...
     * {@link com.wikantik.auth.WikiPrincipal#GUEST}.
     *
     ...
     * </ol>
     * If no primary user Principal is found, this method returns {@link com.wikantik.auth.WikiPrincipal#GUEST}.
     *
     ...
     * @see com.wikantik.auth.AuthenticationManager#isUserPrincipal(Principal)
     */
