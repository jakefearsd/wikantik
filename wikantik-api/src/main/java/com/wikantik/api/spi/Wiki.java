...
public class Wiki {
    ...
    private static final String DEFAULT_PROVIDER_IMPL_ACLS = "com.wikantik.spi.AclsSPIDefaultImpl";
    private static final String DEFAULT_PROVIDER_IMPL_CONTENTS = "com.wikantik.spi.ContentsSPIDefaultImpl";
    private static final String DEFAULT_PROVIDER_IMPL_CONTEXT = "com.wikantik.spi.ContextSPIDefaultImpl";
