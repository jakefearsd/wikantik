...
public abstract class WikiBackgroundThread extends Thread implements WikiEventListener {
    ...
    /**
     * Listens for {@link com.wikantik.event.WikiEngineEvent#SHUTDOWN} and, if detected, marks the thread for death.
     * 
     * @param event {@inheritDoc}
     * @see com.wikantik.event.WikiEventListener#actionPerformed(com.wikantik.event.WikiEvent)
     */
    @Override
     ...
     * it will be re-thrown as a {@link com.wikantik.InternalWikiException}.
     * 
