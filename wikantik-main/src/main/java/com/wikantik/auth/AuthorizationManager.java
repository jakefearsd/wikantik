 ...
 * <ul>
 *   <li>{@link com.wikantik.auth.permissions.WikiPermission} - privileges that apply to an entire wiki instance: <em>e.g.,</em>
 *   editing user profiles, creating pages, creating groups</li>
 *   <li>{@link com.wikantik.auth.permissions.PagePermission} - privileges that apply to a single wiki page or range of pages:
...
public interface AuthorizationManager extends Initializable {
    ...
    /** The default external Authorizer is the {@link com.wikantik.auth.authorize.WebContainerAuthorizer} */
    String DEFAULT_AUTHORIZER = "com.wikantik.auth.authorize.WebContainerAuthorizer";
     ...
     * <ol>
     * <li>The {@link com.wikantik.api.core.Acl} for the page is obtained</li>
     * <li>The Subject associated with the current {@link com.wikantik.api.core.Session} is obtained</li>
     ...
     * or {@link com.wikantik.auth.acl.UnresolvedPrincipal}s (see below). Then iterate through the Subject's Principal set and determine
     ...
     * it could not be initialized. In that case, this method throws a {@link com.wikantik.auth.WikiSecurityException}.
     *
     * @throws com.wikantik.auth.WikiSecurityException if the Authorizer could not be initialized
     ...
     * with the key name {@link com.wikantik.api.core.Context#ATTR_CONTEXT}. Note that this method will automatically redirect the user to
     ...
     * with the key name {@link com.wikantik.api.core.Context#ATTR_CONTEXT}.
     *
     * @param context wiki context to check if it is accesible
     ...
     *
     * @see com.wikantik.event.WikiSecurityEvent
