...
public interface UserManager extends Initializable {
    ...
    /**
     * <p>Retrieves the {@link com.wikantik.auth.user.UserProfile} for the user in a session. If the user is authenticated, the
     ...
     * If a UserProfile needs to be initialized, its {@link com.wikantik.auth.user.UserProfile#isNew()} method will return
     ...
     * <p>If a new UserProfile was created, but its {@link com.wikantik.auth.user.UserProfile#isNew()} method returns
    ...
    /**
     * <p>
     * Saves the {@link com.wikantik.auth.user.UserProfile} for the user in a wiki session. This method verifies that a user profile to
     ...
     * permission to save the profile, this will be a {@link com.wikantik.auth.WikiSecurityException}.
     ...
     * {@link com.wikantik.api.core.Session#getLoginPrincipal()}. Otherwise, the value of the <code>loginname</code> parameter is used.</li>
     * </ul>
     *
     ...
     * (see {@link com.wikantik.api.core.Session#getMessages()}.
     *
     * @param context the current wiki context
