...
/**
 * <p>
 * Deprecated, interface kept in order to keep backwards compatibility with versions up to 2.11.0.M6. {@link com.wikantik.api.core.Acl}
 * should be used instead.
 * </p>
 * {@inheritDoc}
 * @since 2.3
 * @deprecated use {@link com.wikantik.api.core.Acl} instead
 * @see com.wikantik.api.core.Acl
 */
@Deprecated
public interface Acl extends com.wikantik.api.core.Acl {
     ...
     * @deprecated use {@link #addEntry(com.wikantik.api.core.AclEntry)} instead.
     * @see #addEntry(com.wikantik.api.core.AclEntry
     */
    @Deprecated
    default boolean addEntry( final AclEntry entry ) {
        return addEntry( ( com.wikantik.api.core.AclEntry )entry );
    }
     ...
     * @deprecated use {@link #removeEntry(com.wikantik.api.core.AclEntry)} instead.
     * @see #removeEntry(com.wikantik.api.core.AclEntry
     */
    @Deprecated
    default boolean removeEntry( final AclEntry entry ) {
        return removeEntry( ( com.wikantik.api.core.AclEntry )entry );
    }
