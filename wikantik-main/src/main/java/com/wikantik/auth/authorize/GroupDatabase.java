...
public interface GroupDatabase {
     ...
     * {@link com.wikantik.auth.NoSuchPrincipalException}. The method commits the results
     * of the delete to persistent storage.
     * @param group the group to remove
     * @throws WikiSecurityException if the database does not contain the
     * supplied group (thrown as {@link com.wikantik.auth.NoSuchPrincipalException}) or if
