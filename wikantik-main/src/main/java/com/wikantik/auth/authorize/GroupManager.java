...
public interface GroupManager extends Initializable, Authorizer, WikiEventListener {
     ...
     * unless it could not be initialized. In that case, this method throws a {@link com.wikantik.api.exceptions.WikiException}. The
     * GroupDatabase is lazily initialized.
     *
     * @throws com.wikantik.auth.WikiSecurityException if the GroupDatabase could not be initialized
     ...
     * @see com.wikantik.auth.authorize.Group#RESTRICTED_GROUPNAMES
     ...
     * {@link com.wikantik.event.WikiSecurityEvent#GROUP_REMOVE} event with the GroupManager instance as the source and the Group as target.
     ...
     * @see com.wikantik.auth.authorize.GroupDatabase#delete(Group)
     */
     ...
     * </p>
     * <ul>
     * <li><strong>When creating a new Group</strong>, this method fires a {@link com.wikantik.event.WikiSecurityEvent#GROUP_ADD} with
     ...
     * {@link com.wikantik.event.WikiSecurityEvent#GROUP_REMOVE} with this GroupManager instance as the source, and the new Group as the
     * target. It then fires a {@link com.wikantik.event.WikiSecurityEvent#GROUP_ADD} event with the same source and target.</li>
     * </ul>
     * <p>
     ...
     * </p>
     * <p>
     * This method will register the new Group with the GroupManager. For example, {@link com.wikantik.auth.AuthenticationManager}
