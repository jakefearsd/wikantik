...
public final class GroupPermission extends Permission implements Serializable
{
     ...
     * Principals of type {@link com.wikantik.auth.GroupPrincipal}. If the
     ...
     * {@link com.wikantik.auth.AuthorizationManager#checkPermission(com.wikantik.api.core.Session, Permission)},
