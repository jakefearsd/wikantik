...
public final class DefaultUserProfile implements UserProfile {
     ...
     * @see com.wikantik.auth.user.UserProfile#getCreated()
     */
    @Override
     ...
     * @see com.wikantik.auth.user.UserProfile#getLastModified()
     */
    @Override
     ...
     *
     * @see com.wikantik.auth.user.UserProfile#isNew()
     */
    @Override
     ...
     * @see com.wikantik.auth.user.UserProfile#setCreated(java.util.Date)
     */
    @Override
     ...
     * @see com.wikantik.auth.user.UserProfile#setLastModified(java.util.Date)
     */
    @Override
     ...
     * {@link com.wikantik.auth.AuthenticationManager#login(com.wikantik.api.core.Session,HttpServletRequest, String, String)}).
