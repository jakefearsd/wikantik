...
public interface UserDatabase {
     ...
     * instantiate this Principal using {@link com.wikantik.auth.WikiPrincipal#WikiPrincipal(String, String)} with the <code>type</code>
     * parameter set to {@link com.wikantik.auth.WikiPrincipal#WIKI_NAME}. The method
     * {@link com.wikantik.api.core.Session#getUserPrincipal()} will return this principal as the "primary" principal. Note that this method
