 ...
 * a unique ID. Locks are checked by {@link com.wikantik.auth.AuthenticationManager};
...
public interface UserProfile extends Serializable
{
     ...
     * {@link com.wikantik.auth.AuthenticationManager#login(com.wikantik.api.core.Session, jakarta.servlet.http.HttpServletRequest, String, String)},
     * {@link com.wikantik.auth.login.UserDatabaseLoginModule}). The login
