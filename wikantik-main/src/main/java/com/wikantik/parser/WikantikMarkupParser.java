 ...
 *  @since  2.4
 */
public class WikantikMarkupParser extends MarkupParser {
    ...
    private static final Logger LOG = LogManager.getLogger( WikantikMarkupParser.class );
    ...
    private static final String CAMELCASE_PATTERN = "WikantikMarkupParser.camelCasePattern";
     ...
     */
    public WikantikMarkupParser( final Context context, final Reader in ) {
        super( context, in );
        initialize();
    }
