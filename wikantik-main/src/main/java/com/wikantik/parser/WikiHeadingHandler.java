...
/**
 * Handles heading markup for WikantikMarkupParser.
...
public class WikiHeadingHandler {
    ...
    private WikantikMarkupParser cleanTranslator;
     ...
     */
    public WikiHeadingHandler( final WikantikMarkupParser parser,
    ...
    private String makeSectionTitle( String title ) {
        title = title.trim();
        try {
            final WikantikMarkupParser dtr = getCleanTranslator();
