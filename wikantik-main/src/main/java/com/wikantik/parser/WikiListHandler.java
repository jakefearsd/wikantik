...
/**
 * Handles list markup (ordered, unordered, and definition lists) for WikantikMarkupParser.
 *
 * @since 2.12
 */
public class WikiListHandler {
     ...
     */
    public WikiListHandler( final WikantikMarkupParser parser, final WikiFormattingHandler formattingHandler ) {
        this.parser = parser;
