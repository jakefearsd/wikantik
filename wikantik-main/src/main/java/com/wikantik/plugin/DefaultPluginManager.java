...
import com.wikantik.api.plugin.InitializablePlugin;
 ...
 *  <pre>
 *  [{INSERT com.wikantik.plugin.FunnyPlugin  foo='bar'
 *  blob='goo'
 *
 ...
 *  </pre>
 *
 *  The plugin class is "com.wikantik.plugin.FunnyPlugin", the
 ...
 *
 *  <pre>
 *  [{INSERT com.wikantik.plugin.Counter WHERE name='foo'}]
 *  </pre>
 *
 *  is the same as
 *  <pre>
 ...
 *  <pre>
 *  <modules>
 *   <plugin class="com.wikantik.foo.TestPlugin">
 *       <author>Janne Jalkanen</author>
 *       <script>foo.js</script>
 *       <stylesheet>foo.css</stylesheet>
 *       <alias>code</alias>
 *   </plugin>
 *   <plugin class="com.wikantik.foo.TestPlugin2">
 *       <author>Janne Jalkanen</author>
 *   </plugin>
 *   </modules>
 *  </pre>
...
public class DefaultPluginManager extends BaseModuleManager implements PluginManager {
    ...
    private static final String DEFAULT_FORMS_PACKAGE = "com.wikantik.forms";
     ...
     *
     *  @param classname Either a fully fledged class name, or just the name of the file (that is, "com.wikantik.plugin.Counter" or just plain "Counter").
    ...
    public String execute( final Context context, final String commandline ) throws PluginException {
        ...
        try {
            if( matcher.find() ) {
                ...
                final String args = commandline.substring( matcher.end(), endIndex );
