...
/**
 * Word/IP regex blacklist + URL-count limit + UTF-8 trap bucket of the
 ...
 * spam-patterns and IP-patterns regex collections, their wiki-page-driven
 * reload path, and the URL-count + UTF-8 traps out of {@code SpamFilter}
 * into a real implementation behind this interface.</p>
 *
 * <p>TODO Phase 6 Ckpt 3: define the operational surface
 * ({@code matches(String)} / {@code matchesIp(String)} / {@code countUrls(String)} /
 * pattern reload).</p>
 */
