 ...
 * this interface will then carry {@code reindexPage}, {@code pageRemoved},
 * {@code clearIndex}, and the reindex-queue accessors. Until then the slot
 * on {@link com.wikantik.search.subsystem.SearchSubsystem.Services#luceneIndexer()}
 * stays {@code null}.</p>
 */
