...
public class UserProfileTag extends WikiTagBase {
    ...
    /**
     * Returns a sorted list of the {@link com.wikantik.auth.authorize.Group} objects a user possesses
     * in his or her Session. The result is computed by consulting
     * {@link com.wikantik.api.core.Session#getRoles()}
    ...
    /**
     * Returns a sorted list of the {@link com.wikantik.auth.authorize.Role} objects a user possesses
     * in his or her Session. The result is computed by consulting
     * {@link com.wikantik.api.core.Session#getRoles()}
