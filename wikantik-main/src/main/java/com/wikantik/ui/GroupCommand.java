...
public final class GroupCommand {
    ...
    public static final Command DELETE_GROUP = GenericCommand.GROUP_DELETE;
    public static final Command EDIT_GROUP   = GenericCommand.GROUP_EDIT;
    public static final Command VIEW_GROUP   = GenericCommand.GROUP_VIEW;
