...
public class GroupPermissionTest
{
    ...
    public final void testToString()
    {
        ...
        Assertions.assertEquals( "(\"com.wikantik.auth.permissions.GroupPermission\",\"*:Test\",\"delete,edit,view\")", p
                .toString() );
        p = new GroupPermission( "mywiki:Test", "view,edit,delete" );
        Assertions.assertEquals( "(\"com.wikantik.auth.permissions.GroupPermission\",\"mywiki:Test\",\"delete,edit,view\")", p
                .toString() );
    }
