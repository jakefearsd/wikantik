...
public class PagePermissionTest
{
    ...
    public final void testToString()
    {
        ...
        Assertions.assertEquals( "(\"com.wikantik.auth.permissions.PagePermission\",\":Main\",\"delete,edit,view\")", p.toString() );
        p = new PagePermission( "mywiki:Main", "view,edit,delete" );
        Assertions.assertEquals( "(\"com.wikantik.auth.permissions.PagePermission\",\"mywiki:Main\",\"delete,edit,view\")", p.toString() );
    }
