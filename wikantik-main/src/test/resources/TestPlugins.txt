...
''com.wikantik.plugin.WikiPlugin'' interface and can be found from
...
You can also use a shortcut: instead of using {{[[{INSERT com.wikantik.plugin.RecentChangesPlugin}} you can also use {{[[{INSERT RecentChangesPlugin}]}}.  This works only with the plugins that come with Wikantik, though.
