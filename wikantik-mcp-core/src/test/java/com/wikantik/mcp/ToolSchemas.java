 ...
 *
 * <p>Mirrors {@code com.wikantik.mcp.ToolSchemas} in wikantik-admin-mcp/wikantik-knowledge
 * test trees (kept module-local since it's a small test-only helper, not shared production
 * code). See those copies for the full rationale about the mcp-sdk 2.0.0 schema shape change.</p>
 */
