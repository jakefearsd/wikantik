...
/**
 * Mirrors {@code com.wikantik.mcp.tools.kg.QueryNodesToolTest} in wikantik-admin-mcp so
 * this module's own JaCoCo report attributes coverage for {@link QueryNodesTool}, which
 * lives here in wikantik-mcp-core.
 */
