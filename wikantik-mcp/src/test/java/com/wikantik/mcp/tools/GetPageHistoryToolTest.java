...
class GetPageHistoryToolTest {
    ...
    void testHistoryForExistingPage() {
        ...
        assertEquals( "McpHistPage", data.get( "pageName" ) );
        final List< Map< String, Object > > versions = ( List< Map< String, Object > > ) data.get( "versions" );
        assertFalse( versions.isEmpty() );
        // Version should be >= 1, not -1
        assertTrue( ( ( Number ) versions.get( 0 ).get( "version" ) ).intValue() >= 1 );
    }
