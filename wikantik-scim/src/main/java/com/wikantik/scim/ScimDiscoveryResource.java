...
public class ScimDiscoveryResource extends HttpServlet {
    ...
    private static final String SCHEMAS =
        ...
        + "        { \"name\": \"members\",     \"type\": \"complex\",  \"required\": false, \"multiValued\": true, \"mutability\": \"readWrite\", \"returned\": \"default\",\n"
        + "          \"subAttributes\": [\n"
        + "            { \"name\": \"value\",   \"type\": \"string\",  \"required\": false, \"mutability\": \"immutable\", \"returned\": \"default\" },\n"
        + "            { \"name\": \"display\", \"type\": \"string\",  \"required\": false, \"mutability\": \"readOnly\",  \"returned\": \"default\" },\n"
        + "            { \"name\": \"$ref\",    \"type\": \"reference\", \"required\": false, \"mutability\": \"immutable\", \"returned\": \"default\", \"referenceTypes\": [\"User\"] }\n"
        + "          ]\n"
        + "        }\n"
        + "      ],\n"
