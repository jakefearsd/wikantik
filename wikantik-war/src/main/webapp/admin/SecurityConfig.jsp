...
<p>Wikantik wires up its own JAAS to define the authentication process, and does not rely on the JRE configuration. By default, Wikantik configures its JAAS login stack to use the UserDatabaseLoginModule. You can specify a custom login module by setting the <code>jspwiki.loginModule.class</code> property in <code>jspwiki.properties</code>.</p>
